# This code is for batch processing ns3 trace and PHY state logs for scenario 4c (TCP Tx, No PSM, RTT-based LPDS )
...
csvFileName = 'scenario4c10May2021_withDelACK_1.csv'             #changeThisBeforeRun
...
stateDict["TCP_WAIT_ACK"] =  stateDict["IDLE"]                                  # Sleep state while waiting for TCP ACK  - for scenario 4c
stateDict["TCP_TX_RAMPUP"] =  25e-3  
stateDict["TCP_TX_RAMPDOWN"] =  28e-3                               # This will be added after 802.11 ACK Rx - scenario 4c
...
durationDict["TCP_TX_rampDown"]             = 6000                                              # This will be added after 802.11 ACK Rx  - scenario 4c
