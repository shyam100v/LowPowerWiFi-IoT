# This code is for batch processing ns3 trace and PHY state logs for scenario 4b (TCP Tx, No PSM, RTT-based 10 mA Sleep )
...
csvFileName = 'scenario4b10May2021_withDelACK_1.csv'     #changeThisBeforeRun       
...
delACK = 1      # if delayed ACK was enabled in experiment, set this to 1. Else, 0. #changeThisBeforeRun
...
data_folder = Path("TI_ns3_withDelACK_combined/")             #changeThisBeforeRun
