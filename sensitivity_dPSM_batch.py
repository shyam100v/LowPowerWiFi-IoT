# This code is for batch processing ns3 trace and PHY state logs for scenario 4e (TCP Tx, No PSM, Active till TCP ACK )
...
csvFileName = 'scenario4e10May2021_noDelACK_1.csv'     #changeThisBeforeRun       
...
# =============================================================================
                ...
                for tempCounter in range(20):  # Look ahead and change all (20) the following IDLE states to TCP_WAIT_ACK till TCP_ACK is received. This is required in case of PSM
                    ...
                    if (stateVectorModified[ii+tempCounter] == 'BCN_RAMPUP' or stateVectorModified[ii+tempCounter] == 'BCN_MISS_RAMPUP' or stateVectorModified[ii+tempCounter] == 'BCN_RX'):
                        stateVectorModified[ii+tempCounter] = 'ON'
                    if (stateVectorModified[ii+tempCounter] == 'BCN_RAMPDOWN'):
                        stateVectorModified[ii+tempCounter] = 'ON'
                # Adding ramp down after 802.11 ACK rx - not necessary for scenario4e
